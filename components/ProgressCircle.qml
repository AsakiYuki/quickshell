...
Item {
    ...
    property real arcEnd: 270 + rotate            
    property real arcOffset: 0 + rotate   
    property bool isPie: false
    property bool showBackground: false
    property real lineWidth: 20
    property string colorCircle: Catppuccin.text
    property string colorBackground: Catppuccin.surface1
